    ...
    for i in range(1,2**n):
        ...
        for j in range(0,n):
            ...
            if (i&1): 
                ...
                data+=arr[j]
            # Right-shift so that i so that if statement can check for each element in binary form of i    
            i>>=1         
        res.append(data)
    return sorted(res)

def starter():
    print("xoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxox Choose you type of input xoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxoxox")
    time.sleep(1)
